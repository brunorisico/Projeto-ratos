...
class Mice(QMainWindow):
    ...
    def set_to_control_panel(self, timer, trials, serial_connection, vds_name):
        self.setCentralWidget(self.control_panel_widget)
        self.control_panel_widget.setTimerTrialConnection(timer, trials, serial_connection, vds_name)
